...
- **Alertes de session (accueil)** — un bandeau discret quand une session récente mérite qu'on en parle : *« Yakuza — 7 parties d'affilée hier soir, les 3 dernières bien en dessous (indice 77 → 50). »*. Trois déclencheurs : **session trop longue qui s'effondre** (≥ 6 parties et baisse d'indice entre les deux moitiés), **grosse chute de RR**, et **belle remontée** — pour que le bandeau ne soit pas qu'un rabat-joie.
  ...
  Sélection : **une seule alerte par jour** (la plus marquante de la journée), **les jours les plus récents d'abord**, 3 au maximum, et **rien au-delà de 48 h**. La récence prime *toujours* sur la gravité — sans quoi une grosse session d'avant-hier masque celle d'hier soir et le bandeau se fige sur le même évènement pendant des jours. Un clic ouvre le rapport de la session concernée.

  La « journée » en question **coupe à 5 h du matin, pas à minuit** (`DAY_CUTOFF_H`) : une partie jouée dimanche à 2 h appartient à la soirée du **samedi**. Sans ça, une session à cheval sur minuit compterait pour deux jours, et à 2 h du matin le bandeau annoncerait « hier soir » une session finie il y a une heure — il dit « ce soir ».
